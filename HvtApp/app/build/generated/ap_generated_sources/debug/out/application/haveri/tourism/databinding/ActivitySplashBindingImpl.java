...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_splash_icon, 2);
        sViewsWithIds.put(R.id.tv_splash, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((application.haveri.tourism.ui.activity.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable application.haveri.tourism.ui.activity.splash.SplashViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            application.haveri.tourism.utils.BindingUtils.imageSplashUrl(this.ivSplashBg, application.haveri.tourism.utils.AppConstants.SPLASH_IMAGE);
        }
    }
