...
public class FragmentTalukDetailBindingImpl extends FragmentTalukDetailBinding  {
    ...
    public FragmentTalukDetailBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentTalukDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((application.haveri.tourism.ui.fragment.taluk.taluk_detail.TalukDetailFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable application.haveri.tourism.ui.fragment.taluk.taluk_detail.TalukDetailFragmentViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        application.haveri.tourism.ui.fragment.taluk.taluk_detail.TalukDetailFragmentViewModel viewModel = mViewModel;
