...
public class FragmentPlaceImageGalleryBindingImpl extends FragmentPlaceImageGalleryBinding  {
    ...
    public FragmentPlaceImageGalleryBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentPlaceImageGalleryBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((application.haveri.tourism.ui.fragment.place.place_details.gallery.PlaceGalleryFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable application.haveri.tourism.ui.fragment.place.place_details.gallery.PlaceGalleryFragmentViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        application.haveri.tourism.ui.fragment.place.place_details.gallery.PlaceGalleryFragmentViewModel viewModel = mViewModel;
