...
public class LayoutHomeEventItemBindingImpl extends LayoutHomeEventItemBinding implements application.haveri.tourism.generated.callback.OnClickListener.Listener {
    ...
    public LayoutHomeEventItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private LayoutHomeEventItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback14 = new application.haveri.tourism.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((application.haveri.tourism.ui.fragment.home.adapter.event.HomeEventsAdapterViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable application.haveri.tourism.ui.fragment.home.adapter.event.HomeEventsAdapterViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        application.haveri.tourism.ui.fragment.home.adapter.event.HomeEventsAdapterViewModel viewModel = mViewModel;
