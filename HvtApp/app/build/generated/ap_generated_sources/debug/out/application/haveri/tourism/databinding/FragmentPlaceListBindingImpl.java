...
public class FragmentPlaceListBindingImpl extends FragmentPlaceListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((application.haveri.tourism.ui.fragment.place.place_list.PlaceListFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable application.haveri.tourism.ui.fragment.place.place_list.PlaceListFragmentViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        application.haveri.tourism.ui.fragment.place.place_list.PlaceListFragmentViewModel viewModel = mViewModel;
