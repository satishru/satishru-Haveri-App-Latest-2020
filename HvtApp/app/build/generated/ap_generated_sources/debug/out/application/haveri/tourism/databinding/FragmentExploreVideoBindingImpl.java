...
public class FragmentExploreVideoBindingImpl extends FragmentExploreVideoBinding  {
    ...
    public FragmentExploreVideoBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentExploreVideoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((application.haveri.tourism.ui.fragment.videos.video_list.ExploreVideoFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable application.haveri.tourism.ui.fragment.videos.video_list.ExploreVideoFragmentViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        application.haveri.tourism.ui.fragment.videos.video_list.ExploreVideoFragmentViewModel viewModel = mViewModel;
